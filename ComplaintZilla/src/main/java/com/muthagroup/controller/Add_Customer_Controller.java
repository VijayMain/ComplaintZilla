...
public class Add_Customer_Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (!request.getParameter("company").equals("") && !request.getParameter("customer_name").equals("")
					&& !request.getParameter("customer_email").equals("")) {

				index_vo.setCompany(Integer.parseInt(request.getParameter("company")));
				index_vo.setCustomer_name(request.getParameter("customer_name"));
				index_vo.setCustomer_email(request.getParameter("customer_email"));
