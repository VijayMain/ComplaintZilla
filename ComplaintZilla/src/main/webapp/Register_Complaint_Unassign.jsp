						...
						<form class="appnitro" method="post" action="Register_Controller"
							...
							<%
								//************************************************************************************************************
									...
									PreparedStatement ps4 = con.prepareStatement("select * from category_tbl order by Category");
									...
									PreparedStatement ps_pr = con.prepareStatement("select * from Severity_tbl order by p_type");
							...
							<ul>
								...
								<li id="li_5"><label class="description" for="element_5">COMPANY
									...
									<div>
										...
										<select class="element select medium" id="element_5"
											...
											<%
												int comp = 0;
													PreparedStatement ps_unassign_Comp = con
															.prepareStatement("select * from complaint_tbl_unassigned where unassign_id=" + un_ass);
													...
													while (rs_unassign_comp.next()) {
														...
														PreparedStatement pscomp = con
																.prepareStatement("select * from user_tbl_company where company_id=" + comp);
											...
											<%
													...
													PreparedStatement ps_ucomp = con.prepareStatement(
															"select * from user_tbl_company where company_id NOT IN (6," + comp + ")order by Company_Name");
								...
								<li id="li_1"><label class="description" for="element_1">COMPLAINT
										DESCRIPTION </label> <%
 	//System.out.println("out of the loop Unassigned id... : " + un_ass);

 		//System.out.println("Unassigned id... : " + un_ass);
 		PreparedStatement ps_unassign_desc = con.prepareStatement(
 				"select Mail_Content from complaint_tbl_unassigned where unassign_id=" + un_ass);
 ...
 %></li>
										...
										<select class="element select medium" id="element_8"
											...
											<%
												//*************************************Select the department**************************** 
													...
													PreparedStatement ps_dept = con.prepareStatement("select * from user_tbl_dept order by department");
								...
								<%
									int un_ass1 = 0;
										...
										//System.out.println("out of the loop Unassigned id... : " + un_ass1);

										//System.out.println("Unassigned id... : " + un_ass1);
										PreparedStatement ps_unassign_desc1 = con
												.prepareStatement("select * from complaint_tbl_unassigned where unassign_id=" + un_ass1);
									...
									<div>
										<%
											while (rs_unassign_desc1.next()) {
													Timestamp timestamp = rs_unassign_desc1.getTimestamp("Mail_Received_Date");
