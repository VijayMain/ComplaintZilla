	...
	<select name="assigned" id="assigned" style="height: 25px;">
		...
		<%
			try {
				...
				stmt1 = connection.prepareStatement("select * from user_tbl where Company_Id=" + i
						+ " and dept_id!=8 and dept_id!=9 and Enable_id=1 order by U_Name");
		...
		<%
				...
				PreparedStatement ps_corp = connection.prepareStatement(
						"select * from user_tbl where U_Id in(select u_id from complaint_corporate_tbl)");
