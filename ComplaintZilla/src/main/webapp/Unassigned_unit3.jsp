...
<body>
	...
	<%
		...
		if (request.getParameter("name") == null) {
			...
			order = "Mail_Subject";
		} else if (request.getParameter("name").equals("Mail_Received_Date")) {
				...
				<div class="content-module">
					...
					<form name="myForm" method="post" action="oldUrl.do" id="myForm"
						...
						<select name="modeOfT" id="choice">
							...
							<%
								PreparedStatement ps_cp = con.prepareStatement("select * from user_tbl_company  where Company_Id!=6");
									...
									<form name="frm">
										...
										<table width="100%" cellpadding="0" cellspacing="0" border="0">
											<thead>
												...
												<%
													//System.out.println("Unassigned mail= " + request.getParameter("name"));
												%>
											</thead>
											...
											<tr onmouseover="ChangeColor(this, true);"
												...
												<%
													PreparedStatement ps_cmp = con.prepareStatement(
																	"select * from user_tbl_company where Company_Id=" + rsPagination.getInt("Company_Id"));
